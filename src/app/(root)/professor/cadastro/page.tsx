  ...
  return (
    <div>
      <section className="pink_container !min-h-[50px]">
        ...
        <p className="text-white">Preencha os dados corretamente.</p>
      </section>

      <div className="flex justify-center text-center space-x-2 w-full">
        <div>
          <h1 className="text-2xl">Clique aqui para alterar o tipo de cadastro</h1>
          <div className="flex-between">
            ...
            <Switch id="tipoForm" checked={manualRegister} onCheckedChange={setManualRegister} />
          </div>
        </div>
      </div>
