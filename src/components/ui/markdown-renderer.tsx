...
const COMPONENTS: Components = {
  ...
  code: ({ children, className, node: _node, ...rest }: MarkdownCodeProps) => {
    void _node;
...
function withClass(Tag: keyof HTMLElementTagNameMap, classes: string) {
  const Component = ({ node: _node, ...props }: MarkdownElementProps) => {
    void _node;
