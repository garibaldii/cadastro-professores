...
export function MessageInput({
  placeholder = "Pergunte à nossa assistente",
  className,
  ...
  const emitTranscriptionChange = (text: string) => {
    if (!props.onChange) return;

    const target = { value: text } as HTMLTextAreaElement;
  ...
  const {
    ...
    transcribeAudio,
    onTranscriptionComplete: emitTranscriptionChange,
  });
