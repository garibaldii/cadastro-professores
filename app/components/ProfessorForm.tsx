...
import z from 'zod'
import { getReferencias, getStatusAtividade, getTitulacoes, saveProfessor } from "@/lib/actions";
        ...
        <form action={formAction} className='cadastro-form'>
            ...
            <div className='flex-between'>
                <div>
                    ...
                    {errors.titulacao && <p className="startup-form_error">{errors.titulacao}</p>}
                </div>
                ...
                <div >
                    ...
                    {errors.referencia && <p className="startup-form_error">{errors.referencia}</p>}
                ...
                <div>
                    ...
                    {errors.statusAtividade && <p className="startup-form_error">{errors.statusAtividade}</p>}
                </div>
            </div>
            ...
            {errors.idUnidade && <p className="startup-form_error">{errors.idUnidade}</p>}
